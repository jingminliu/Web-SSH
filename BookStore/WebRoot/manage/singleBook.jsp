  ...
  <body>
    <center>
		...
		<div id="managePage">
			...
			<div id="manageBook" style="width:100%;background-color: white;margin-top: -200px;margin-left: 180px;">
			<s:action name="singleBookAction" executeResult="false"></s:action>
				<ul class="singleBookUl" style="width: 100%">
					<li class="singleBookName" style="color: black;background-color: yellow;width: 100%">
