...
<link href="ccs/admin.css" type="text/css" rel="stylesheet">
<base href="<%=basePath%>">
<style type="text/css">
A:link{
...
<table cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
	...
	<tr>
		<td bgColor=#b1ceef heigh=1></td></tr>
	<tr height=20>
...
<table cellSpacing=0 cellPadding=0 width="90" align=center border=0>
	<tr height=100>
		...
		<td width=60>&nbsp;</td>
		<td>
			<table height=100 cellSpacing=0 cellPadding=0 width="100%" boder=0>
				<tr>
					<td>当前时间：<span id="myclock"></span></td></tr>
				<tr>
					<td style="FONT-WEIGH:bold;FONT-SIZE:16px">${user.nic}</td></tr>
				<tr>
					<td>欢迎进入用户管理中心！</td></tr></table></td></tr>
	<tr>
		<td colSpan=3 heigh=10></td></tr></table>
<table cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
	<tr height=20>
		<td></td></tr>
	<tr height=22>
		<td style="PADDING-LEFT:20px; FONT-WEIGHT: bold;COLOR:#ffffff" align=middle background=images/title_bg2.jpg>所有用户信息列表如下</td></tr>
