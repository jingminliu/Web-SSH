       ...
       我的相册<br/><br/>
        <form action="createFolder" method="post">
         <table border=0 class="wwFormTable">
          <tr height="20"><td>相册名称:</td><td><input type="text" name="folder.folderName"/></td></tr>
          <tr><td>相册说明:</td><td><input type="text" name="folder.folderInfo"/></td></tr>
          <tr><td>访问权限:</td>
           <td><select name="folder.limit">
           <option value="0">允许所有人访问</option>
           <option value="1" selected="selected">只允许好友访问</option>
           <option value="2">不允许任何人访问</option></select></td>
          </tr>
          <tr><td width="60px"><td rowspan="2"><input type="submit" value="添加"/></td></tr>
       </table>
        </form>
    </div>
  </tr>
